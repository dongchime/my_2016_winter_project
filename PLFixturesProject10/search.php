<?php
  ...
  $query2 = "SELECT * FROM `plfixturesproject`.`fixtures` WHERE Date='$date'";
  $res2 = mysql_query($query2) or die(mysql_error());

  $query3 = "SELECT * FROM `plfixturesproject`.`fixtures` WHERE Location='$location'";
  ...
  if ($date==null)
  {
    ...
    echo "<table border=1 <tr> <th>HomeTeam</th> <th>AwayTeam</th> <th>Date</th> <th>Time</th> <th>Location</th> </tr>";
    while($fetch=mysql_fetch_array($res2, MYSQL_ASSOC))
    {
      echo "<tr>";
      echo "<td>" . $fetch['HomeTeam'] . "</td>";
      echo "<td>" . $fetch['AwayTeam'] . "</td>";
  ...
  if ($location==null)
  {
    ...
    echo "<table border=1 <tr> <th>HomeTeam</th> <th>AwayTeam</th> <th>Date</th> <th>Time</th> <th>Location</th> </tr>";
    while($fetch=mysql_fetch_array($res3, MYSQL_ASSOC))
    {
      echo "<tr>";
      echo "<td>" . $fetch['HomeTeam'] . "</td>";
      echo "<td>" . $fetch['AwayTeam'] . "</td>";
